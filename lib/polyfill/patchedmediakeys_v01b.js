...
shaka.polyfill.PatchedMediaKeys.v01b.install = function() {
  ...
  v01b.MediaKeyStatusMap.KEY_ID_ = (new Uint8Array([0])).buffer;

  // Install patches.
  var nav = (window.Navigator && window.Navigator.prototype) ||
      window.navigator;
  nav.requestMediaKeySystemAccess = v01b.requestMediaKeySystemAccess;
