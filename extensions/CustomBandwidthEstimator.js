...
goog.provide('shaka.util.CustomBandwidthEstimator');
 ...
 * @export
 */
shaka.util.CustomBandwidthEstimator = function() {
...
goog.inherits(shaka.util.CustomBandwidthEstimator, shaka.util.FakeEventTarget);


/** @override */
shaka.util.CustomBandwidthEstimator.prototype.sample = function(delayMs, bytes) {
...
/** @override */
shaka.util.CustomBandwidthEstimator.prototype.getBandwidth = function() {
...
/** @override */
shaka.util.CustomBandwidthEstimator.prototype.getDataAge = function() {
  return (Date.now() - this.lastSampleTime_) / 1000;
};


/** @override */
shaka.util.CustomBandwidthEstimator.prototype.supportsCaching = function() {
  return true;
};
